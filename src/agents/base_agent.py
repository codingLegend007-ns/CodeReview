...
This module defines the abstract :class:`BaseAgent`, which serves as a template for creating CrewAI agents.
It enforces the implementation of core agent attributes (role, goal, backstory) and the factory method
``create_agent``. The class supports lazy initialization of the underlying CrewAI agent and provides
